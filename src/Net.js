...
import { Netflixs } from "./Array";
import { useState } from "react";
import { Link } from "react-router-dom";
function Netflix() {
const[query, setQuery] = useState("");
const newdate = new Date().getHours(14);
...
<div className="Net">
        ...
        <div className="Net">
        <Link to="/YouTube">
        <img src="https://i.ytimg.com/vi/JYWezI9BN0s/maxresdefault.jpg" alt="mypic" className="Net__img" />
        </Link>
        </div>
    </div>
{Netflixs.filter((user)=>
